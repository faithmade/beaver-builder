...
<div class="fl-templates-override-nodes">
	<p><?php _e( 'You may also choose to show your row and module templates as sections within the builder panel. A new section will be created for each row or module category that you have defined.', 'fl-builder' ); ?></p>
	<p>
		<label>
			<input type="checkbox" name="fl-templates-override-rows" value="1" <?php checked( $show_rows, 1 ); ?> />
			<span><?php _e( 'Show Row Templates?', 'fl-builder' ); ?></span>
		</label>
	</p>
	<p>
		<label>
			<input type="checkbox" name="fl-templates-override-modules" value="1" <?php checked( $show_modules, 1 ); ?> />
			<span><?php _e( 'Show Module Templates?', 'fl-builder' ); ?></span>
		</label>
	</p>
</div>